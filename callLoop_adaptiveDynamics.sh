...
branchFile=pop_${popsize}_nGens_${genMax}_loops_${loops}_Ignore.txt
...
do
    ...
    -r "plot_adaptiveDynamicsContour('${productionFile}',\
...
while false; do
    ...
    case $yn in
        [Yy]* ) /Applications/MATLAB_R2019b.app/bin/matlab -nodesktop -nosplash \
                -r "justRecordBranching_adaptiveDynamics('${productionFile}',\
                '${neighborhoodSizeFile}',${genMax},${popsize},${recordInt},'${matlabFigure1}', \
                '${matlabFigure2}','${matlabFigure3}','${branchFile}');pause(5);exit;"
                break;;
