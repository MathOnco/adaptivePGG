...
#Show the expected number of gens to extinction based on
#population size and eq. frequency of defectors (calculated elsewhere)
#print(function(100, 0.175028))

#Optionally, Make Plot
x_axis=np.linspace(10,500,30)
y_axis=np.zeros(30)
for i in range(30):
    y_axis[i]=function(int(np.round(x_axis[i])), 0.175028)
...
plt.title("Transition Matrix Results for Larger Populations")
plt.xlabel("Population Size")
plt.ylabel("Generations to Extinction (Log-scale)")
#plt.show()
plt.savefig('/Users/4472241/adaptiveDynamics/logScalefig6.pdf')